...
class SPTSZ_lowl(SlikPlugin):
    ...
    def __init__(self,
        ...
        #Cut out bandpowers not in range of lmin and lmax
        if lmin is not None:
        ...
        #Calculate beam correlation matrix
    ...
    # returns chi^2 for residual of data and theory
    def __call__(self,
                 cmb):
    ...
    # Get CMB model add in foregrounds and account for abberation
    ...
    # Function for calculating beam correlation matrix
...
# This class loads foreground templates when inititializeed. The __call__ method returns foreground powerspectrum for given amplitudes
