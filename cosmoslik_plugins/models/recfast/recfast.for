...
C	Atomic data for HeI 
	...
	data	AGauss2		/0.05D0/	!Amplitude of 2nd Gaussian
	data	zGauss1		/7.28D0/	!ln(1+z) of 1st Gaussian
	data	zGauss2		/6.75D0/	!ln(1+z) of 2nd Gaussian
	data	wGauss1		/0.18D0/	!Width of 1st Gaussian
	data	wGauss2		/0.33D0/	!Width of 2nd Gaussian
C	Gaussian fits for extra H physics (fit by Adam Moss)
...
C	dimensions for integrator
	...
	write(*,*)' with H fudge factor = 1.14 (or 1.105 plus high z fit),'
