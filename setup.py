...
setup(name='CosmoSlik',
      ...
      ext_modules=[
          ...
          Extension("cosmoslik_plugins.utils.cyquad.cyquad",
                    ...
                    language='c++'),
          numpy.distutils.Extension("cosmoslik_plugins.models.hubble_theta_convert.hubble_theta_convert",
                    ['cosmoslik_plugins/models/hubble_theta_convert/f_hubble_theta.f90'],
                    language='f90'),
      ],
      package_data = {
